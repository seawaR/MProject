...
```{r seqplot-cluster-a-entropy, out.width = "350px", results = "hide", fig.cap = "Transversal entropy by cluster for the base scenario."}
...
```{r seqplot-cluster-b-entropy, out.width = "300px", results = "hide", fig.cap = "Transversal entropy for two clusters in the base scenario."}
par(mar = par()$mar * c(0.5, 1, 0.5, 1)) # Reduce bottom and top margin by 50%.
