...
```{r, out.width = "350px", fig.align = "center", results = "hide", fig.cap = "Transversal entropy by cluster."}
...
```{r plot-seqdplot-2, out.width = "400px", fig.align = "center", fig.cap = "Distribution of states for two clusters."}
seqdplot(results$sd,
...
```{r, out.width = "350px", fig.align = "center", results = "hide", fig.cap = "Transversal entropy for two clusters."}
