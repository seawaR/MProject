...
Table \@ref(tab:toy-trate) shows the transition frequencies or probabilities for the observed sequences.
...
Now, suppose we want to obtain the cost matrix with the method `TRATE` with $c=2$.
...
To obtain the distance matrix we can opt for none or one of the normalization methods mentioned in the previous subsection. Table \@ref(tab:toy-dists) shows some descriptive statistics of the obtained distances for different methods of normalization.
