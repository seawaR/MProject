...
```{r neuro3, out.width = "250px", fig.align = "center"}
eval_experiments %>%
...
```{r neuro7, out.width = "250px", fig.align = "center"}
eval_experiments %>%
  tibble::add_column(Scenario = 1:13) %>%
  select(Scenario, result) %>%
  tidyr::unnest(result) %>%
...
```{r open, out.width = "250px", fig.align = "center"}
eval_experiments %>%
  tibble::add_column(Scenario = 1:13) %>%
  select(Scenario, result) %>%
  tidyr::unnest(result) %>%
...
```{r extra, out.width = "250px", fig.align = "center"}
eval_experiments %>%
  tibble::add_column(Scenario = 1:13) %>%
  select(Scenario, result) %>%
  tidyr::unnest(result) %>%
...
```{r cons, out.width = "250px", fig.align = "center"}
eval_experiments %>%
  tibble::add_column(Scenario = 1:13) %>%
  select(Scenario, result) %>%
  tidyr::unnest(result) %>%
...
```{r agree, fig.width = 7.5, fig.height = 5.25, out.width = "250px", fig.align = "center"}
eval_experiments %>%
  tibble::add_column(Scenario = 1:13) %>%
  select(Scenario, result) %>%
  tidyr::unnest(result) %>%
