...
Figure \@ref(fig:plot-seqdplot-0) shows the overall distribution of states at each time point.
...
As before, we  want to explore possible links between the information from the sequences and personality scores. Figure \@ref(fig:cluster-b-traits-dist) shows the distribution of the personality traits for the two clusters.
