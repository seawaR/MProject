...
my_dist <- seqdist(my_seq,
  method = "OM", sm = cost_matrix_1,
...
seqdplot(my_seq,
  group = clusters5_labels, border = NA,
  ltext = status_labels
)
invisible(dev.off())
...
## ---- echo=FALSE, message=FALSE------------------------
data_all <- tibble(
  Id = colnames(my_dist), Cluster_5 = clusters5_labels,
...
## ---- out.width = "350px", fig.align = "center"--------
seqdplot(my_seq,
  group = clusters2_labels, border = NA,
