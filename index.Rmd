...
The common objective of many of these studies is to find similarities and differences between the sequences and obtain groups of trajectories that are similar by means of a clustering method applied to the matrix distance obtained from optimal matching.
...
<!-- To do Danielito:
- Can we merge list of figures and tables?
-->
